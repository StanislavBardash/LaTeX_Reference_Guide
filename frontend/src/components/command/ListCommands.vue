    ...
    <div id="app">
      ...
      <div class="container10">
        <div class = "searchnav">
          ...
          <input type="text" id="category-search" v-model="categorySearchQuery"> -->
      ...
      return this.commands.slice(start, end);
        ...
        methods: { // методы компонента
          getCategories() {
            ...
            getCommands() {
                http
                    .get("/findAllVerified") // обращаемся к серверу для получения списка пользователей
                    .then(response => { // запрос выполнен успешно
