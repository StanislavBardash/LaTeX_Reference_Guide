var dbProperties = {
    database: 'latex', // название базы данных
...
db.code_example = require('../model/code_example.model.js')(sequelize, Sequelize);
db.command_tag = require('../model/command_tag.model.js')(sequelize, Sequelize);
...
db.favourite = require('../model/favourite.model.js')(sequelize, Sequelize);
